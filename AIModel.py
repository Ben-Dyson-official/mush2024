...
TRAINING_DIR = '/Users/bendyson/Coding/gitRepos/mush2024/constellation_data/train/'
...
# Same for validation
VALIDATION_DIR = '/Users/bendyson/Coding/gitRepos/mush2024/constellation_data/validate/'
...
callbacks = EarlyStopping(moniter='val_loss', patience=5, verbose=1, mode='auto')
best_model_file = '/Users/bendyson/Coding/gitRepos/mush2024/CNN_best_weights.h5'
best_model = ModelCheckpoint(best_model_file, moniter='val_acc', verbose=1, save_best_onoly=True)
